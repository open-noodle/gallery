...
> [!NOTE]
> This is a **community fork** of [Immich](https://github.com/immich-app/immich) with additional features and improvements. Currently based on **Immich v3.2.2**. We regularly sync with upstream to stay up to date. See [What's Different](#whats-different-from-upstream-immich) below.
...
- **[Pet Detection](https://opennoodle.de/features/pet-detection)** — RF-DETR detects cats and dogs and surfaces them alongside people. ([Docs](https://docs.opennoodle.de/features/pet-detection))
