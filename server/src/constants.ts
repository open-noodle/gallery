...
export const endpointTags: Record<ApiTag, string> = {
  ...
  [ApiTag.Family]:
    'Family relationships between people, expressed as a graph of unions rather than a single tree. Access is granted per user by an admin and scoped to what each viewer can already resolve.',
