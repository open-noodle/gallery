  ...
  describe('getMetrics', () => {
    it('returns low-cardinality asset, user, search, state, face, and person metrics', async () => {
      ...
      await Promise.all([
        ...
        ctx.newAssetFace({ assetId: image1.id, personGroupId: person1.personGroupId, isVisible: true }),
        ctx.newAssetFace({ assetId: image1.id, personGroupId: person1.personGroupId, isVisible: true }),
        ctx.newAssetFace({ assetId: video1.id, personGroupId: person2.personGroupId, isVisible: true }),
        ctx.newAssetFace({ assetId: video1.id, personGroupId: person2.personGroupId, isVisible: false }),
        ctx.newAssetFace({ assetId: video1.id, personGroupId: null, isVisible: true }),
        ctx.newAssetFace({ assetId: hidden.id, personGroupId: person2.personGroupId, isVisible: true }),
        ctx.newAssetFace({ assetId: trashed.id, personGroupId: person2.personGroupId, isVisible: true }),
