...
class SharedSpaceAlbumAssetEntity extends Table
    with
        TableInfo<
          SharedSpaceAlbumAssetEntity,
          SharedSpaceAlbumAssetEntityData
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SharedSpaceAlbumAssetEntity(this.attachedDatabase, [this._alias]);
  ...
  @override
  SharedSpaceAlbumAssetEntityData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  SharedSpaceAlbumAssetEntity createAlias(String alias) {
    return SharedSpaceAlbumAssetEntity(attachedDatabase, alias);
  }
...
class SharedSpaceAlbumAssetEntityData extends DataClass
    implements Insertable<SharedSpaceAlbumAssetEntityData> {
  ...
  SharedSpaceAlbumAssetEntityData copyWith({
    String? albumId,
    String? assetId,
  }) => SharedSpaceAlbumAssetEntityData(
  ...
  SharedSpaceAlbumAssetEntityData copyWithCompanion(
    SharedSpaceAlbumAssetEntityCompanion data,
  ) {
    return SharedSpaceAlbumAssetEntityData(
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SharedSpaceAlbumAssetEntityData &&
          other.albumId == this.albumId &&
          other.assetId == this.assetId);
}

class SharedSpaceAlbumAssetEntityCompanion
    extends UpdateCompanion<SharedSpaceAlbumAssetEntityData> {
  ...
  SharedSpaceAlbumAssetEntityCompanion.insert({
    ...
    required String assetId,
       ...
       assetId = Value(assetId);
  static Insertable<SharedSpaceAlbumAssetEntityData> custom({
  ...
  SharedSpaceAlbumAssetEntityCompanion copyWith({
    Value<String>? albumId,
    Value<String>? assetId,
  }) {
    return SharedSpaceAlbumAssetEntityCompanion(
      albumId: albumId ?? this.albumId,
      assetId: assetId ?? this.assetId,
    );
  }
...
class SharedSpaceAlbumLinkEntity extends Table
    with TableInfo<SharedSpaceAlbumLinkEntity, SharedSpaceAlbumLinkEntityData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SharedSpaceAlbumLinkEntity(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> spaceId = GeneratedColumn<String>(
    'space_id',
    aliasedName,
    false,
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {spaceId, albumId};
  @override
  SharedSpaceAlbumLinkEntityData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  SharedSpaceAlbumLinkEntity createAlias(String alias) {
    return SharedSpaceAlbumLinkEntity(attachedDatabase, alias);
  }
  ...
  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(space_id, album_id)',
  ];
  @override
  bool get dontWriteConstraints => true;
}

class SharedSpaceAlbumLinkEntityData extends DataClass
    implements Insertable<SharedSpaceAlbumLinkEntityData> {
  final String spaceId;
  final String albumId;
  final int showInTimeline;
  ...
  SharedSpaceAlbumLinkEntityData copyWith({
    String? spaceId,
    String? albumId,
    int? showInTimeline,
    ...
    String? createdAt,
    String? updatedAt,
  }) => SharedSpaceAlbumLinkEntityData(
    spaceId: spaceId ?? this.spaceId,
    albumId: albumId ?? this.albumId,
    showInTimeline: showInTimeline ?? this.showInTimeline,
  ...
  SharedSpaceAlbumLinkEntityData copyWithCompanion(
    SharedSpaceAlbumLinkEntityCompanion data,
  ) {
    return SharedSpaceAlbumLinkEntityData(
      spaceId: data.spaceId.present ? data.spaceId.value : this.spaceId,
      albumId: data.albumId.present ? data.albumId.value : this.albumId,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SharedSpaceAlbumLinkEntityData &&
          other.spaceId == this.spaceId &&
          other.albumId == this.albumId &&
          other.showInTimeline == this.showInTimeline &&
...
class SharedSpaceAlbumLinkEntityCompanion
    extends UpdateCompanion<SharedSpaceAlbumLinkEntityData> {
  final Value<String> spaceId;
  final Value<String> albumId;
  final Value<int> showInTimeline;
  ...
  SharedSpaceAlbumLinkEntityCompanion.insert({
    ...
    this.updatedAt = const Value.absent(),
       ...
       albumId = Value(albumId);
  static Insertable<SharedSpaceAlbumLinkEntityData> custom({
    Expression<String>? spaceId,
    Expression<String>? albumId,
    Expression<int>? showInTimeline,
  ...
  SharedSpaceAlbumLinkEntityCompanion copyWith({
    Value<String>? spaceId,
    Value<String>? albumId,
    Value<int>? showInTimeline,
    ...
    return SharedSpaceAlbumLinkEntityCompanion(
      spaceId: spaceId ?? this.spaceId,
      albumId: albumId ?? this.albumId,
      showInTimeline: showInTimeline ?? this.showInTimeline,
...
class SharedSpaceAlbumHiddenEntity extends Table
    with
        TableInfo<
          SharedSpaceAlbumHiddenEntity,
          SharedSpaceAlbumHiddenEntityData
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SharedSpaceAlbumHiddenEntity(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> spaceId = GeneratedColumn<String>(
    'space_id',
    aliasedName,
    false,
  ...
  @override
  List<GeneratedColumn> get $columns => [spaceId, albumId, userId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {spaceId, albumId, userId};
  @override
  SharedSpaceAlbumHiddenEntityData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  SharedSpaceAlbumHiddenEntity createAlias(String alias) {
    return SharedSpaceAlbumHiddenEntity(attachedDatabase, alias);
  }
  ...
  @override
  List<String> get customConstraints => const [
    'PRIMARY KEY(space_id, album_id, user_id)',
  ];
  @override
  bool get dontWriteConstraints => true;
}

class SharedSpaceAlbumHiddenEntityData extends DataClass
    implements Insertable<SharedSpaceAlbumHiddenEntityData> {
  final String spaceId;
  final String albumId;
  final String userId;
  ...
  SharedSpaceAlbumHiddenEntityData copyWith({
    String? spaceId,
    String? albumId,
    String? userId,
  }) => SharedSpaceAlbumHiddenEntityData(
  ...
  SharedSpaceAlbumHiddenEntityData copyWithCompanion(
    SharedSpaceAlbumHiddenEntityCompanion data,
  ) {
    return SharedSpaceAlbumHiddenEntityData(
      spaceId: data.spaceId.present ? data.spaceId.value : this.spaceId,
      albumId: data.albumId.present ? data.albumId.value : this.albumId,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SharedSpaceAlbumHiddenEntityData &&
          other.spaceId == this.spaceId &&
          other.albumId == this.albumId &&
          other.userId == this.userId);
}
...
class SharedSpaceAlbumHiddenEntityCompanion
    extends UpdateCompanion<SharedSpaceAlbumHiddenEntityData> {
  final Value<String> spaceId;
  final Value<String> albumId;
  final Value<String> userId;
  ...
  SharedSpaceAlbumHiddenEntityCompanion.insert({
    ...
    required String userId,
       ...
       albumId = Value(albumId),
       userId = Value(userId);
  static Insertable<SharedSpaceAlbumHiddenEntityData> custom({
    Expression<String>? spaceId,
    Expression<String>? albumId,
    Expression<String>? userId,
  }) {
  ...
  SharedSpaceAlbumHiddenEntityCompanion copyWith({
    Value<String>? spaceId,
    Value<String>? albumId,
    Value<String>? userId,
  }) {
    return SharedSpaceAlbumHiddenEntityCompanion(
      spaceId: spaceId ?? this.spaceId,
      albumId: albumId ?? this.albumId,
      userId: userId ?? this.userId,
    );
...
class SharedSpaceAlbumEntity extends Table
    with TableInfo<SharedSpaceAlbumEntity, SharedSpaceAlbumEntityData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SharedSpaceAlbumEntity(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  SharedSpaceAlbumEntityData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  SharedSpaceAlbumEntity createAlias(String alias) {
    return SharedSpaceAlbumEntity(attachedDatabase, alias);
  }
...
class SharedSpaceAlbumEntityData extends DataClass
    implements Insertable<SharedSpaceAlbumEntityData> {
  final String id;
  final String name;
  final String? description;
  final String? thumbnailAssetId;
  ...
  SharedSpaceAlbumEntityData copyWith({
    String? id,
    String? name,
    Value<String?> description = const Value.absent(),
    Value<String?> thumbnailAssetId = const Value.absent(),
  ...
  SharedSpaceAlbumEntityData copyWithCompanion(
    SharedSpaceAlbumEntityCompanion data,
  ) {
    return SharedSpaceAlbumEntityData(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SharedSpaceAlbumEntityData &&
          other.id == this.id &&
          other.name == this.name &&
          other.description == this.description &&
          other.thumbnailAssetId == this.thumbnailAssetId &&
...
class SharedSpaceAlbumEntityCompanion
    extends UpdateCompanion<SharedSpaceAlbumEntityData> {
  final Value<String> id;
  final Value<String> name;
  final Value<String?> description;
  final Value<String?> thumbnailAssetId;
  ...
  SharedSpaceAlbumEntityCompanion.insert({
    ...
    this.order = const Value.absent(),
       ...
       name = Value(name);
  static Insertable<SharedSpaceAlbumEntityData> custom({
    Expression<String>? id,
    Expression<String>? name,
    Expression<String>? description,
    Expression<String>? thumbnailAssetId,
  ...
  SharedSpaceAlbumEntityCompanion copyWith({
    Value<String>? id,
    Value<String>? name,
    Value<String?>? description,
    Value<String?>? thumbnailAssetId,
    ...
    return SharedSpaceAlbumEntityCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      description: description ?? this.description,
      thumbnailAssetId: thumbnailAssetId ?? this.thumbnailAssetId,
...
class SharedSpaceAlbumFolderEntity extends Table
    with
        TableInfo<
          SharedSpaceAlbumFolderEntity,
          SharedSpaceAlbumFolderEntityData
        > {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SharedSpaceAlbumFolderEntity(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  SharedSpaceAlbumFolderEntityData map(
    Map<String, dynamic> data, {
    String? tablePrefix,
  }) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  SharedSpaceAlbumFolderEntity createAlias(String alias) {
    return SharedSpaceAlbumFolderEntity(attachedDatabase, alias);
  }
...
class SharedSpaceAlbumFolderEntityData extends DataClass
    implements Insertable<SharedSpaceAlbumFolderEntityData> {
  final String id;
  final String spaceId;
  ...
  SharedSpaceAlbumFolderEntityData copyWith({
    String? id,
    String? spaceId,
  ...
  SharedSpaceAlbumFolderEntityData copyWithCompanion(
    SharedSpaceAlbumFolderEntityCompanion data,
  ) {
    return SharedSpaceAlbumFolderEntityData(
      id: data.id.present ? data.id.value : this.id,
      spaceId: data.spaceId.present ? data.spaceId.value : this.spaceId,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SharedSpaceAlbumFolderEntityData &&
          other.id == this.id &&
          other.spaceId == this.spaceId &&
...
class SharedSpaceAlbumFolderEntityCompanion
    extends UpdateCompanion<SharedSpaceAlbumFolderEntityData> {
  final Value<String> id;
  final Value<String> spaceId;
  ...
  SharedSpaceAlbumFolderEntityCompanion.insert({
    ...
    this.updatedAt = const Value.absent(),
       ...
       spaceId = Value(spaceId),
       name = Value(name);
  static Insertable<SharedSpaceAlbumFolderEntityData> custom({
    Expression<String>? id,
    Expression<String>? spaceId,
  ...
  SharedSpaceAlbumFolderEntityCompanion copyWith({
    Value<String>? id,
    Value<String>? spaceId,
    ...
    return SharedSpaceAlbumFolderEntityCompanion(
      id: id ?? this.id,
      spaceId: spaceId ?? this.spaceId,
...
class DatabaseAtV38 extends GeneratedDatabase {
  ...
  late final SharedSpaceAlbumAssetEntity sharedSpaceAlbumAssetEntity =
      SharedSpaceAlbumAssetEntity(this);
  late final SharedSpaceAlbumLinkEntity sharedSpaceAlbumLinkEntity =
  ...
  late final Index idxSharedSpaceAlbumHiddenAlbumSpace = Index(
  ...
  late final Index idxSharedSpaceAlbumLinkSpace = Index(
  ...
  late final Index idxSharedSpaceAlbumLinkAlbumSpace = Index(
  ...
  late final Index idxSharedSpaceAlbumAssetAlbum = Index(
  ...
  late final Index idxSharedSpaceAlbumAssetAssetAlbum = Index(
  ...
  late final SharedSpaceAlbumEntity sharedSpaceAlbumEntity =
      SharedSpaceAlbumEntity(this);
  late final SharedSpaceAlbumFolderEntity sharedSpaceAlbumFolderEntity =
      SharedSpaceAlbumFolderEntity(this);
  ...
  late final Index idxSharedSpaceAlbumFolderSpace = Index(
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities => [
    ...
    idxSharedSpaceAlbumHiddenAlbumSpace,
    ...
    idxSharedSpaceAlbumFolderSpace,
    idxPersonOwnerId,
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [
        TableUpdate('shared_space_album_link_entity', kind: UpdateKind.delete),
      ],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
