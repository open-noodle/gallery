...
void main() {
  ...
  group('PlacesPickerPage no-location entries', () {
    testWidgets('offers the no-location entries when the server allows them', (tester) async {
      ...
      expect(find.widgetWithText(InkWell, StaticTranslations.instance.filter_location_no_place_name), findsOneWidget);
    });
    ...
    testWidgets('hides the no-location entries when the server says they would match nothing', (tester) async {
      ...
      expect(find.widgetWithText(InkWell, StaticTranslations.instance.filter_location_no_gps), findsNothing);
      expect(find.widgetWithText(InkWell, StaticTranslations.instance.filter_location_no_place_name), findsNothing);
    });
