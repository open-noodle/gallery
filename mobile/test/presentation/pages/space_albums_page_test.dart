...
/// the album-api-repo, but without overriding it here the real `albumApiRepositoryProvider`
...
/// `albumApiRepositoryProvider` -> `apiServiceProvider` -> `NetworkRepository` trap entirely
