...
/// Checksum algorithm
enum LibraryManifestAssetDtoChecksumAlgorithmEnum {
  sha1._(r'sha1'),
  sha1Path._(r'sha1-path'),
  ;

  /// Instantiate a new enum with the provided value.
  const LibraryManifestAssetDtoChecksumAlgorithmEnum._(this._value);
  ...
  /// Returns the instance of [LibraryManifestAssetDtoChecksumAlgorithmEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [LibraryManifestAssetDtoChecksumAlgorithmEnum]
...
class LibraryManifestAssetDtoChecksumAlgorithmEnumTypeTransformer {
  ...
  String encode(LibraryManifestAssetDtoChecksumAlgorithmEnum data) => data._value;
  ...
  LibraryManifestAssetDtoChecksumAlgorithmEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is LibraryManifestAssetDtoChecksumAlgorithmEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
