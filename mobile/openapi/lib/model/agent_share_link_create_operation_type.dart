...
enum AgentShareLinkCreateOperationType {
  shareLinkPeriodCreate._(r'shareLink.create'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentShareLinkCreateOperationType._(this._value);
  ...
  /// Returns the instance of [AgentShareLinkCreateOperationType] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentShareLinkCreateOperationType]
...
class AgentShareLinkCreateOperationTypeTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(AgentShareLinkCreateOperationType data) => data._value;
  ...
  AgentShareLinkCreateOperationType? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentShareLinkCreateOperationType) {
      return data;
    }
    if (data != null) {
      switch (data) {
