...
class AgentOperationExistingSpaceTargetKind {
  /// Instantiate a new enum with the provided [value].
  const AgentOperationExistingSpaceTargetKind._(this.value);
  ...
  static const existingSpace = AgentOperationExistingSpaceTargetKind._(r'existing_space');

  /// List of all possible values in this [enum][AgentOperationExistingSpaceTargetKind].
  static const values = <AgentOperationExistingSpaceTargetKind>[
    existingSpace,
  ];
...
class AgentOperationExistingSpaceTargetKindTypeTransformer {
  ...
  String encode(AgentOperationExistingSpaceTargetKind data) => data.value;

  /// Decodes a [dynamic value][data] to a AgentOperationExistingSpaceTargetKind.
  ///
  ...
  /// Singleton [AgentOperationExistingSpaceTargetKindTypeTransformer] instance.
