...
enum AgentListDuplicateGroupsToolDeniedResponseStatusEnum {
  denied._(r'denied'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentListDuplicateGroupsToolDeniedResponseStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentListDuplicateGroupsToolDeniedResponseStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentListDuplicateGroupsToolDeniedResponseStatusEnum]
...
class AgentListDuplicateGroupsToolDeniedResponseStatusEnumTypeTransformer {
  ...
  String encode(AgentListDuplicateGroupsToolDeniedResponseStatusEnum data) => data._value;
  ...
  AgentListDuplicateGroupsToolDeniedResponseStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentListDuplicateGroupsToolDeniedResponseStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
