...
enum AgentListDuplicateGroupsToolSuccessResponseStatusEnum {
  success._(r'success'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentListDuplicateGroupsToolSuccessResponseStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentListDuplicateGroupsToolSuccessResponseStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentListDuplicateGroupsToolSuccessResponseStatusEnum]
...
class AgentListDuplicateGroupsToolSuccessResponseStatusEnumTypeTransformer {
  ...
  String encode(AgentListDuplicateGroupsToolSuccessResponseStatusEnum data) => data._value;
  ...
  AgentListDuplicateGroupsToolSuccessResponseStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentListDuplicateGroupsToolSuccessResponseStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
