...
enum AgentProposeAlbumOperationsDtoOperationsInnerOneOf20PayloadAxisEnum {
  horizontal._(r'horizontal'),
  vertical._(r'vertical'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentProposeAlbumOperationsDtoOperationsInnerOneOf20PayloadAxisEnum._(this._value);
  ...
  /// Returns the instance of [AgentProposeAlbumOperationsDtoOperationsInnerOneOf20PayloadAxisEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentProposeAlbumOperationsDtoOperationsInnerOneOf20PayloadAxisEnum]
...
class AgentProposeAlbumOperationsDtoOperationsInnerOneOf20PayloadAxisEnumTypeTransformer {
  ...
  String encode(AgentProposeAlbumOperationsDtoOperationsInnerOneOf20PayloadAxisEnum data) => data._value;
  ...
  AgentProposeAlbumOperationsDtoOperationsInnerOneOf20PayloadAxisEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentProposeAlbumOperationsDtoOperationsInnerOneOf20PayloadAxisEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
