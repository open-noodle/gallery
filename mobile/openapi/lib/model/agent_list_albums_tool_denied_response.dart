...
enum AgentListAlbumsToolDeniedResponseStatusEnum {
  denied._(r'denied'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentListAlbumsToolDeniedResponseStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentListAlbumsToolDeniedResponseStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentListAlbumsToolDeniedResponseStatusEnum]
...
class AgentListAlbumsToolDeniedResponseStatusEnumTypeTransformer {
  ...
  String encode(AgentListAlbumsToolDeniedResponseStatusEnum data) => data._value;
  ...
  AgentListAlbumsToolDeniedResponseStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentListAlbumsToolDeniedResponseStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
