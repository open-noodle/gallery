...
enum AgentSearchUsersToolResponseDtoStatusEnum {
  success._(r'success'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentSearchUsersToolResponseDtoStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentSearchUsersToolResponseDtoStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentSearchUsersToolResponseDtoStatusEnum]
...
class AgentSearchUsersToolResponseDtoStatusEnumTypeTransformer {
  ...
  String encode(AgentSearchUsersToolResponseDtoStatusEnum data) => data._value;
  ...
  AgentSearchUsersToolResponseDtoStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentSearchUsersToolResponseDtoStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
