...
enum AgentOperationItemSelectionOneOf1ModeEnum {
  allExcept._(r'allExcept'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentOperationItemSelectionOneOf1ModeEnum._(this._value);
  ...
  /// Returns the instance of [AgentOperationItemSelectionOneOf1ModeEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentOperationItemSelectionOneOf1ModeEnum]
...
class AgentOperationItemSelectionOneOf1ModeEnumTypeTransformer {
  ...
  String encode(AgentOperationItemSelectionOneOf1ModeEnum data) => data._value;
  ...
  AgentOperationItemSelectionOneOf1ModeEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentOperationItemSelectionOneOf1ModeEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
