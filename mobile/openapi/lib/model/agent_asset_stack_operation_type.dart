...
class AgentAssetStackOperationType {
  /// Instantiate a new enum with the provided [value].
  const AgentAssetStackOperationType._(this.value);
  ...
  static const assetPeriodStack = AgentAssetStackOperationType._(r'asset.stack');

  /// List of all possible values in this [enum][AgentAssetStackOperationType].
  static const values = <AgentAssetStackOperationType>[
    assetPeriodStack,
  ];
...
class AgentAssetStackOperationTypeTypeTransformer {
  ...
  String encode(AgentAssetStackOperationType data) => data.value;

  /// Decodes a [dynamic value][data] to a AgentAssetStackOperationType.
  ///
  ...
  /// Singleton [AgentAssetStackOperationTypeTypeTransformer] instance.
