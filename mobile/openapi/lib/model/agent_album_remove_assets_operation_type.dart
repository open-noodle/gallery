  ...
  static List<AgentAlbumRemoveAssetsOperationType> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AgentAlbumRemoveAssetsOperationType.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [AgentAlbumRemoveAssetsOperationType] to String,
/// and [decode] dynamic data back to [AgentAlbumRemoveAssetsOperationType].
class AgentAlbumRemoveAssetsOperationTypeTypeTransformer {
  factory AgentAlbumRemoveAssetsOperationTypeTypeTransformer() => _instance ??= const AgentAlbumRemoveAssetsOperationTypeTypeTransformer._();
