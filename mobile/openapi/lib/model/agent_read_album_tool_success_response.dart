...
enum AgentReadAlbumToolSuccessResponseStatusEnum {
  success._(r'success'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentReadAlbumToolSuccessResponseStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentReadAlbumToolSuccessResponseStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentReadAlbumToolSuccessResponseStatusEnum]
...
class AgentReadAlbumToolSuccessResponseStatusEnumTypeTransformer {
  ...
  String encode(AgentReadAlbumToolSuccessResponseStatusEnum data) => data._value;
  ...
  AgentReadAlbumToolSuccessResponseStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentReadAlbumToolSuccessResponseStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
