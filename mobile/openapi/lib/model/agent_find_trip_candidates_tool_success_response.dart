...
enum AgentFindTripCandidatesToolSuccessResponseStatusEnum {
  success._(r'success'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentFindTripCandidatesToolSuccessResponseStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentFindTripCandidatesToolSuccessResponseStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentFindTripCandidatesToolSuccessResponseStatusEnum]
...
class AgentFindTripCandidatesToolSuccessResponseStatusEnumTypeTransformer {
  ...
  String encode(AgentFindTripCandidatesToolSuccessResponseStatusEnum data) => data._value;
  ...
  AgentFindTripCandidatesToolSuccessResponseStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentFindTripCandidatesToolSuccessResponseStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
