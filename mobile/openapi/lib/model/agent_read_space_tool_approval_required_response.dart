...
enum AgentReadSpaceToolApprovalRequiredResponseStatusEnum {
  approvalRequired._(r'approval-required'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentReadSpaceToolApprovalRequiredResponseStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentReadSpaceToolApprovalRequiredResponseStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentReadSpaceToolApprovalRequiredResponseStatusEnum]
...
class AgentReadSpaceToolApprovalRequiredResponseStatusEnumTypeTransformer {
  ...
  String encode(AgentReadSpaceToolApprovalRequiredResponseStatusEnum data) => data._value;
  ...
  AgentReadSpaceToolApprovalRequiredResponseStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentReadSpaceToolApprovalRequiredResponseStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
