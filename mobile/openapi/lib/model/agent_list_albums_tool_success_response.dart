...
enum AgentListAlbumsToolSuccessResponseStatusEnum {
  success._(r'success'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentListAlbumsToolSuccessResponseStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentListAlbumsToolSuccessResponseStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentListAlbumsToolSuccessResponseStatusEnum]
...
class AgentListAlbumsToolSuccessResponseStatusEnumTypeTransformer {
  ...
  String encode(AgentListAlbumsToolSuccessResponseStatusEnum data) => data._value;
  ...
  AgentListAlbumsToolSuccessResponseStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentListAlbumsToolSuccessResponseStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
