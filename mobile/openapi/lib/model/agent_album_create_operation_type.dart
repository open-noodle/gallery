...
enum AgentAlbumCreateOperationType {
  albumPeriodCreate._(r'album.create'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentAlbumCreateOperationType._(this._value);
  ...
  /// Returns the instance of [AgentAlbumCreateOperationType] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentAlbumCreateOperationType]
...
class AgentAlbumCreateOperationTypeTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(AgentAlbumCreateOperationType data) => data._value;
  ...
  AgentAlbumCreateOperationType? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentAlbumCreateOperationType) {
      return data;
    }
    if (data != null) {
      switch (data) {
