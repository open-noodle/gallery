  ...
  static List<AgentSearchAssetsOrder> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AgentSearchAssetsOrder.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [AgentSearchAssetsOrder] to String,
/// and [decode] dynamic data back to [AgentSearchAssetsOrder].
class AgentSearchAssetsOrderTypeTransformer {
  factory AgentSearchAssetsOrderTypeTransformer() => _instance ??= const AgentSearchAssetsOrderTypeTransformer._();
  ...
  AgentSearchAssetsOrder? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'desc': return AgentSearchAssetsOrder.desc;
        case r'relevance': return AgentSearchAssetsOrder.relevance;
        default:
          if (!allowNull) {
