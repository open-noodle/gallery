...
enum AgentPermissionPreset {
  careful._(r'careful'),
  visualOrganizer._(r'visual-organizer'),
  localPowerUser._(r'local-power-user'),
  custom._(r'custom'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentPermissionPreset._(this._value);
  ...
  /// Returns the instance of [AgentPermissionPreset] that was successfully decoded
  /// from the passed [value] on success, null otherwise.
  static AgentPermissionPreset? fromJson(dynamic value) => AgentPermissionPresetTypeTransformer().decode(value);

  /// Returns a [List] containing instances of [AgentPermissionPreset]
...
class AgentPermissionPresetTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(AgentPermissionPreset data) => data._value;
  ...
  AgentPermissionPreset? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentPermissionPreset) {
      return data;
    }
    if (data != null) {
      switch (data) {
