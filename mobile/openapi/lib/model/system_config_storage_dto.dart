...
class SystemConfigStorageDto {
  ...
  SystemConfigStorageRoutingDto routing;
  ...
  @override
  String toString() => 'SystemConfigStorageDto[routing=$routing]';
  ...
  static SystemConfigStorageDto? fromJson(dynamic value) {
    ...
    if (value is Map) {
      ...
      return SystemConfigStorageDto(
        routing: SystemConfigStorageRoutingDto.fromJson(json[r'routing'])!,
      );
    }
    return null;
  }
