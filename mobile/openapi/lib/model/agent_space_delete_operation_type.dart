...
class AgentSpaceDeleteOperationType {
  /// Instantiate a new enum with the provided [value].
  const AgentSpaceDeleteOperationType._(this.value);
  ...
  static const spacePeriodDelete = AgentSpaceDeleteOperationType._(r'space.delete');

  /// List of all possible values in this [enum][AgentSpaceDeleteOperationType].
  static const values = <AgentSpaceDeleteOperationType>[
    spacePeriodDelete,
  ];
...
class AgentSpaceDeleteOperationTypeTypeTransformer {
  ...
  String encode(AgentSpaceDeleteOperationType data) => data.value;

  /// Decodes a [dynamic value][data] to a AgentSpaceDeleteOperationType.
  ///
  ...
  /// Singleton [AgentSpaceDeleteOperationTypeTypeTransformer] instance.
