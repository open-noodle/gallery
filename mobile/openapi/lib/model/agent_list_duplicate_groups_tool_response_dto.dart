...
enum AgentListDuplicateGroupsToolResponseDtoStatusEnum {
  success._(r'success'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentListDuplicateGroupsToolResponseDtoStatusEnum._(this._value);
  ...
  /// Returns the instance of [AgentListDuplicateGroupsToolResponseDtoStatusEnum] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentListDuplicateGroupsToolResponseDtoStatusEnum]
...
class AgentListDuplicateGroupsToolResponseDtoStatusEnumTypeTransformer {
  ...
  String encode(AgentListDuplicateGroupsToolResponseDtoStatusEnum data) => data._value;
  ...
  AgentListDuplicateGroupsToolResponseDtoStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentListDuplicateGroupsToolResponseDtoStatusEnum) {
      return data;
    }
    if (data != null) {
      switch (data) {
