...
enum AgentAlbumAddAssetsOperationType {
  albumPeriodAddAssets._(r'album.addAssets'),
  ;

  /// Instantiate a new enum with the provided value.
  const AgentAlbumAddAssetsOperationType._(this._value);
  ...
  /// Returns the instance of [AgentAlbumAddAssetsOperationType] that was successfully decoded
  ...
  /// Returns a [List] containing instances of [AgentAlbumAddAssetsOperationType]
...
class AgentAlbumAddAssetsOperationTypeTypeTransformer {
  ...
  /// Encodes this enum as a value suitable for JSON.
  String encode(AgentAlbumAddAssetsOperationType data) => data._value;
  ...
  AgentAlbumAddAssetsOperationType? decode(dynamic data, {bool allowNull = true}) {
    if (data is AgentAlbumAddAssetsOperationType) {
      return data;
    }
    if (data != null) {
      switch (data) {
