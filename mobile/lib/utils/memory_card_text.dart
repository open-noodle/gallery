...
String buildMemoryTitle(DriftMemory memory, {required Translate translate, required String locale, DateTime? now}) {
...
String getMemoryTitle(BuildContext context, DriftMemory memory) => buildMemoryTitle(
  memory,
  translate: (key, {args}) => key.t(context: context, args: args),
