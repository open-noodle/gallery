...
class _SpaceAlbumEmptyStateState extends State<SpaceAlbumEmptyState> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final content = <Widget>[
      ...
      Text(
        'space_album_empty_title'.t(context: context),
        textAlign: TextAlign.center,
        style: context.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600),
      ),
      const SizedBox(height: 10),
      Text(
        (canAdd ? 'space_album_empty_subtitle' : 'space_album_empty_subtitle_viewer').t(context: context),
        textAlign: TextAlign.center,
      ...
      if (canAdd) ...[
        ...
        FilledButton.icon(
          ...
          label: Text('space_album_add_photos'.t(context: context)),
        ),
      ],
    ];
