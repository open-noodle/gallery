...
class MergedAssetDrift extends i1.ModularAccessor {
  ...
  i11.$SharedSpaceAlbumHiddenEntityTable get sharedSpaceAlbumHiddenEntity =>
      i1.ReadDatabaseContainer(
        attachedDatabase,
      ).resultSet<i11.$SharedSpaceAlbumHiddenEntityTable>(
        'shared_space_album_hidden_entity',
      );
  i12.$LocalAlbumAssetEntityTable get localAlbumAssetEntity =>
      i1.ReadDatabaseContainer(
        attachedDatabase,
      ).resultSet<i12.$LocalAlbumAssetEntityTable>('local_album_asset_entity');
  i13.$LocalAlbumEntityTable get localAlbumEntity => i1.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i13.$LocalAlbumEntityTable>('local_album_entity');
}
