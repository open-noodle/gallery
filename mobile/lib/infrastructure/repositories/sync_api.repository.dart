...
class SyncApiRepository {
  ...
  /// The original five Phase-2B space-album request types — every fork server that shipped
  /// version-gated space albums (pre-M14 capability signalling) accepts exactly these. Safe
  /// to send from the `serverVersion > 5.0.0` fallback below.
