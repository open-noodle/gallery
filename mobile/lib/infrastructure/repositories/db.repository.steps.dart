...
final class Schema37 extends i0.VersionedSchema {
  ...
  late final Shape65 sharedSpaceAlbumHiddenEntity = Shape65(
    source: i0.VersionedTable(
      entityName: 'shared_space_album_hidden_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(space_id, album_id, user_id)'],
      columns: [_column_159, _column_231, _column_253],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  final i1.Index idxSharedSpaceAlbumHiddenAlbumSpace = i1.Index(
...
final class Schema38 extends i0.VersionedSchema {
  ...
  late final Shape66 sharedSpaceAlbumLinkEntity = Shape66(
    source: i0.VersionedTable(
      entityName: 'shared_space_album_link_entity',
      withoutRowId: true,
      isStrict: true,
  ...
  late final Shape67 sharedSpaceAlbumFolderEntity = Shape67(
    source: i0.VersionedTable(
      entityName: 'shared_space_album_folder_entity',
      withoutRowId: true,
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(id)'],
      columns: [
  ...
  final i1.Index idxSharedSpaceAlbumFolderSpace = i1.Index(
