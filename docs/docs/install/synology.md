...
Once your project completes the build process, your containers will start. In order to be able to access Gallery from your browser, you need to configure the firewall settings for your Synology NAS to allow communication between the Gallery containers.
