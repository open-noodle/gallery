...
To import a Google Photos Takeout, use Gallery's [Google Photos Import](/features/google-photos-import) in the web app. For command-line workflows, the community-maintained [immich-go](https://github.com/simulot/immich-go) tool is still handy.
:::
