...
Gallery enforces strict role-based access on every endpoint. See the [full permissions matrix](/docs/plans/2026-03-23-spaces-permissions-matrix.md) for a detailed breakdown of what each role can and cannot do across all asset, search, download, people, and management operations.
:::
