...
const SWAPPED_SET = [
  ...
  'lib/components/faces-page/PersonPickerGrid.svelte',
  'lib/components/faces-page/PersonSidePanel.svelte',
  'lib/components/asset-viewer/face-editor/SpaceFaceEditor.svelte',
  'lib/components/asset-viewer/ImagePanoramaViewer.svelte',
  'lib/components/asset-viewer/SpacePersonSidePanel.svelte',
