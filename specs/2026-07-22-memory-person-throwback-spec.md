...
| 16  | `specs/2026-07-15-memory-types-roadmap.md`                  | #9 Status → **Shipped**; also correct #12's status (§8)                |
...
`docs/docs/install/config-file.md`, `specs/2026-07-15-memory-types-roadmap.md`.
**Depends on:** Slice 4.
