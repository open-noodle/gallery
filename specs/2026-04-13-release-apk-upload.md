...
**Design doc:** `specs/2026-04-13-release-apk-upload-design.md` — read this first if anything below is unclear.
...
Design: `specs/2026-04-13-release-apk-upload-design.md`
...
If you find yourself wanting to add any of these, stop and re-read `specs/2026-04-13-release-apk-upload-design.md` — the rationale for rejecting each is documented there.
