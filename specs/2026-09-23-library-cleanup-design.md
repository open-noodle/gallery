...
| `GET /cleanup/rewind/{monthDay}/{year}` | Returns that year's assets: `{id, type, originalFileName, localDateTime, thumbhash, width, height, duration, fileSize, isFavorite, inAlbum, kept, city}`. The queue pages use the same asset shape                                                                                                                                                                                                                                                                                                                     |
