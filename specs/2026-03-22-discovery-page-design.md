...
**Primary mockup:** `specs/mockups/discovery-independent-panel.html` (the "Left"
option). Open this file in a browser to see expanded and collapsed states side by side.

**Temporal picker detail:** `specs/mockups/discovery-navigation-phase3.html` for
...
Interactive HTML mockups are in `specs/mockups/`:
