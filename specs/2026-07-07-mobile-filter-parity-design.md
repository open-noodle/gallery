...
**Interactive prototype:** `specs/mockups/2026-07-07-mobile-filter-parity-mockup.html` (open in a browser; tap the deep-sheet section headers to try collapse)
...
**Parity target:** the web filter panel (`web/src/lib/components/filter-panel/`) and its redesign spec `specs/2026-06-17-filter-panel-redesign-design.md`.
