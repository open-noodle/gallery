...
**Related:** `specs/upstream-reports/2026-04-20-upstream-sync.md`
...
| 4   | Mobile smoke checklist        | **Manual**            | ~10 min (human) | `specs/upstream-reports/rebase-mobile-smoke-checklist.md`                      |
...
**File:** `specs/upstream-reports/rebase-mobile-smoke-checklist.md`
**Tier:** Manual
