...
**Mockup:** [`specs/mockups/2026-04-18-mobile-bottom-nav.html`](./mockups/2026-04-18-mobile-bottom-nav.html)
...
- **Mobile filter sheet** (`specs/2026-04-17-mobile-filter-sheet-design.md`) — the FilterSheet the search blob opens.
...
See [`specs/mockups/2026-04-18-mobile-bottom-nav.html`](./mockups/2026-04-18-mobile-bottom-nav.html). Interactive: tap or press `P` / `A` / `L` to switch active. Demonstrates dark + light themes, per-destination active state, edge states (multi-select, keyboard, landscape, readonly).
