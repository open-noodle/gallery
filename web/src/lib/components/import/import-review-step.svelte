...
<div class="flex flex-col gap-6">
  ...
  <div class="rounded-xl border border-gray-200 p-6 dark:border-gray-700">
    ...
    {#if missingDates > 0}
      <div class="mt-4 flex items-center gap-2 rounded-lg bg-yellow-50 p-3 text-sm text-yellow-700 dark:bg-yellow-900/20 dark:text-yellow-400">
  ...
  <div data-testid="albums-section" class="rounded-xl border border-gray-200 p-6 dark:border-gray-700">
    ...
    <div class="max-h-64 overflow-y-auto">
      {#each albums as album}
        ...
        >
          <Checkbox
            checked={selectedAlbums.has(album.name)}
            onCheckedChange={() => onToggleAlbum(album.name)}
          />
          <div class="flex-1">
