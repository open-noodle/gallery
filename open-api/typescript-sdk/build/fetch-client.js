 ...
 */
export function runFaceRepair({ faceRepairRequestDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson("/admin/face-repair", oazapfts.json({
        ...opts,
        method: "POST",
 ...
 */
export function getLibraryManifest({ cursor, id }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/admin/users/${encodeURIComponent(id)}/library-manifest${QS.query(QS.explode({
        cursor
    }))}`, {
        ...opts
    }));
...
export function getAlbumNames(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/albums/names", {
        ...opts
    }));
}
/**
 ...
 */
export function getMapMarkers({ fileCreatedAfter, fileCreatedBefore, isArchived, isFavorite, withPartners, withSharedAlbums, withSharedSpaces }, opts) {
 ...
 * Get all people
 */
export function getAllPeople({ closestAssetId, closestPersonId, page, size, withHidden, withSharedSpaces }, opts) {
 ...
 */
export function getPeopleFaceStatistics({ closestAssetId, closestPersonId, page, size, withHidden, withSharedSpaces }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/people/face-statistics${QS.query(QS.explode({
        closestAssetId,
        closestPersonId,
        page,
        size,
 ...
 */
export function getPeopleStatistics({ closestAssetId, closestPersonId, page, size, withHidden, withSharedSpaces }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/people/statistics${QS.query(QS.explode({
        closestAssetId,
        closestPersonId,
        page,
        size,
...
export function getPersonFaces({ id, page, size }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/people/${encodeURIComponent(id)}/faces${QS.query(QS.explode({
        page,
        size
    }))}`, {
        ...opts
...
export function getPersonFaceThumbnail({ faceId, id }, opts) {
    return oazapfts.ok(oazapfts.fetchBlob(`/people/${encodeURIComponent(id)}/faces/${encodeURIComponent(faceId)}/thumbnail`, {
        ...opts
    }));
}
/**
 ...
 */
export function updateRepresentativeFace({ id, representativeFaceUpdateDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/people/${encodeURIComponent(id)}/representative-face`, oazapfts.json({
        ...opts,
        method: "PUT",
...
export function searchSmartFacets({ smartSearchFacetsDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson("/search/smart/facets", oazapfts.json({
        ...opts,
        method: "POST",
...
export function getMlHealth(opts) {
    return oazapfts.ok(oazapfts.fetchJson("/server/ml-health", {
        ...opts
    }));
}
/**
 ...
 */
export function updateMemberPreferences({ id, sharedSpaceMemberPreferencesDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/shared-spaces/${encodeURIComponent(id)}/members/me/preferences`, oazapfts.json({
        ...opts,
        method: "PATCH",
 ...
 */
export function updateMemberMetadataContribution({ id, userId, sharedSpaceMemberMetadataContributionDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/shared-spaces/${encodeURIComponent(id)}/members/${encodeURIComponent(userId)}/metadata-contribution`, oazapfts.json({
        ...opts,
        method: "PATCH",
 ...
 */
export function getSpacePeople({ id, limit, name, named, offset, takenAfter, takenBefore, withHidden }, opts) {
 ...
 */
export function getSpacePeopleFaceStatistics({ id, limit, name, named, offset, takenAfter, takenBefore, withHidden }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/shared-spaces/${encodeURIComponent(id)}/people/face-statistics${QS.query(QS.explode({
        limit,
        name,
        named,
        offset,
 ...
 */
export function getSpacePeopleStatistics({ id, limit, name, named, offset, takenAfter, takenBefore, withHidden }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/shared-spaces/${encodeURIComponent(id)}/people/statistics${QS.query(QS.explode({
        limit,
        name,
        named,
        offset,
...
export function getSpacePersonFaces({ id, page, personId, size }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/shared-spaces/${encodeURIComponent(id)}/people/${encodeURIComponent(personId)}/faces${QS.query(QS.explode({
        page,
        size
    }))}`, {
        ...opts
...
export function getSpacePersonFaceThumbnail({ faceId, id, personId }, opts) {
    return oazapfts.ok(oazapfts.fetchBlob(`/shared-spaces/${encodeURIComponent(id)}/people/${encodeURIComponent(personId)}/faces/${encodeURIComponent(faceId)}/thumbnail`, {
        ...opts
    }));
}
/**
 ...
 */
export function updateSpacePersonRepresentativeFace({ id, personId, spaceRepresentativeFaceUpdateDto }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/shared-spaces/${encodeURIComponent(id)}/people/${encodeURIComponent(personId)}/representative-face`, oazapfts.json({
        ...opts,
        method: "PUT",
...
export function getSpacePersonStatistics({ id, personId }, opts) {
    return oazapfts.ok(oazapfts.fetchJson(`/shared-spaces/${encodeURIComponent(id)}/people/${encodeURIComponent(personId)}/statistics`, {
        ...opts
    }));
}
/**
...
(function (ChecksumAlgorithm) {
    ...
    ChecksumAlgorithm["Sha1Path"] = "sha1-path";
...
(function (ManualJobName) {
    ...
    ManualJobName["SharedSpacePersonMetadataBackfill"] = "shared-space-person-metadata-backfill";
...
(function (Type2) {
    Type2["Person"] = "person";
    Type2["SpacePerson"] = "space-person";
})(Type2 || (Type2 = {}));
...
(function (JobName) {
    ...
    JobName["SharedSpaceFaceMatchFromBackfill"] = "SharedSpaceFaceMatchFromBackfill";
    JobName["SharedSpaceLibraryFaceSync"] = "SharedSpaceLibraryFaceSync";
    JobName["SharedSpaceIdentityReconciliation"] = "SharedSpaceIdentityReconciliation";
    JobName["SharedSpacePersonDedup"] = "SharedSpacePersonDedup";
    JobName["SharedSpacePersonMetadataBackfill"] = "SharedSpacePersonMetadataBackfill";
